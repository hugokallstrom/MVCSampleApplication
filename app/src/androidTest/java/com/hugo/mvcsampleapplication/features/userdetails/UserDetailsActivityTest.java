...
import static com.hugo.mvcsampleapplication.OrientationChangeAction.orientationLandscape;
...
public class UserDetailsActivityTest {
  ...
  private MVCApplication getApp() {
    return (MVCApplication) InstrumentationRegistry.getInstrumentation()
        .getTargetContext()
